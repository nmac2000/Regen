...
climate <- left_join(climate, mmm_hd, by = "SampleSite_ID")
climate <- left_join(climate, mmm_sf, by = "SampleSite_ID")
climate <- left_join(climate, bin_dis_GIS1, by = "SampleSite_ID")
