...
## Download files from "Files Needed" folder in 
## Forest Biometrics - Eskelson lab/Documents/General/Chilcotin Plateau/R files/Nat/Regeneration Drivers/Files Needed
## Keep file name the same, but edit this R file so the file pathway reflects your own interface
## These files should exist in some capacity in Forest Biometrics - Eskelson lab/Documents/General/Chilcotin Plateau/Data, but this follows my existing naming convention

regen <- "C:/Users/ EDIT THIS /Regen_2023_ALL.csv"
regen <- read.csv(regen)
GIS_i <- "C:/Users/ EDIT THIS /Regen_Points_May2.csv"
GIS_i <- read.csv(GIS_i)
clipGis <- "C:/Users/ EDIT THIS /PossiblePlot.csv"
clipGis <- read.csv(clipGis)
distance <- "C:/Users/ EDIT THIS /distance.csv"
distance <- read.csv(distance)
fire_severity <- "C:/Users/ EDIT THIS /FireSeverity.csv"
fire_severity <- read.csv(fire_severity)
patchsize <- read.csv("C:/Users/ EDIT THIS /PatchSize.csv")
```
...
# export dataframe
write.csv(regen_combo, "C:/Users/ EDIT THIS /MeasuredPlots.csv")
```
...
write.csv(GIS_i, "C:/Users/ EDIT THIS /GIS_fixed.csv")
...
```{r}
not_measured_list <-c(2042, 1840, 1701, 2208, 1609, 2646, 1598, 1942, 2043, 1623, 2269, 2115, 1482, 2213, 2334, 1936, 1724, 193, 318, 1209, 1267, 499, 1836, 361, 545, 907, 1467, 1297, 1423, 1831, 585, 1796, 2271, 1807, 865, 315, 329, 456, 496, 1108, 1422, 1514, 1643)

not_measured <- regen_combo_STM %>% 
...
write.csv(regen_GIS,  "C:/Users/ EDIT THIS /regen_GIS.csv")
regen_GIS <- read.csv("C:/Users/ EDIT THIS /regen_GIS.csv")
```
...
write.csv(regen_binary, "C:/Users/ EDIT THIS /regen_GIS.csv/regen_binary.csv")
...
# For Analysis
```{r}
bin_dis_GIS1 <- read.csv("C:/Users/ EDIT THIS /regen_binary.csv")
...
#write.csv(bin_dis_GIS1, "C:/Users/ EDIT THIS /bin_dis_GIS3.csv")
bin_dis_GIS1 <- read.csv("C:/Users/ EDIT THIS /bin_dis_GIS3.csv")
