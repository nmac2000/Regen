...
site.FDI.2b <- glm(FDI.f ~ years_since + BEC_Zone + PARENT_SOILS,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.FDI.2b)
lrtest(site.FDI.2b, site.FDI.2a)

site.FDI.2c <- glm(FDI.f ~ years_since + BEC_Zone + PARENT_SOILS + Elevation,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.FDI.2c)
lrtest(site.FDI.2c, site.FDI.2b)

site.FDI.2d <- glm(FDI.f ~ years_since + BEC_Zone + PARENT_SOILS + Slope,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.FDI.2d)
lrtest(site.FDI.2d, site.FDI.2b)

site.FDI.2e <- glm(FDI.f ~ years_since + BEC_Zone + PARENT_SOILS + Slope + Solar_Radiation,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.FDI.2e)
...
site.FDI.2f <- glm(FDI.f ~ years_since + BEC_Zone + PARENT_SOILS + Solar_Radiation,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.FDI.2f)
lrtest(site.FDI.2f, site.FDI.2e)

site.FDI.2g <- glm(FDI.f ~ years_since + BEC_Zone + PARENT_SOILS + Solar_Radiation + TWI,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.FDI.2g)
lrtest(site.FDI.2g, site.FDI.2f)

site.FDI.2h <- glm(FDI.f ~ years_since + BEC_Zone + PARENT_SOILS + Solar_Radiation + Aspect,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.FDI.2h)
lrtest(site.FDI.2h, site.FDI.2f)
```
