...
lrtest(structure.FDI.3k, structure.FDI.2e)

structure.FDI.3l <- glm(FDI.f ~  Distance + SPECIES_CD_1_1 + SPECIES_CD_2_1 +
                          PROJ_HEIGHT_1_1 ,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(structure.FDI.3l)
lrtest(structure.FDI.3l, structure.FDI.2e)
```
