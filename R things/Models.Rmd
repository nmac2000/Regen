...
logistic.GLM1c1 <- glm(PLI.f ~ CROWN_CLOSURE_1 ,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1c1) #not significant on own
...
logistic.GLM1.1b <- glm(PLI.f ~  years_since + PROJ_AGE_1_1 + DISTURBANCE_TYPE_1 ,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1.1b)

logistic.GLM1.1c <- glm(PLI.f ~  years_since + PROJ_AGE_1_1 + DISTURBANCE_TYPE_1 + DISTANCE_TO_PERIMETER + BURN_SEVERITY_RATING_1,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1.1c)

logistic.GLM1.1d <- glm(PLI.f ~  years_since + PROJ_AGE_1_1 + DISTURBANCE_TYPE_1 + DISTANCE_TO_PERIMETER,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1.1d)

logistic.GLM1.1e <- glm(PLI.f ~   PROJ_AGE_1_1 + PROJ_HEIGHT_1_1 + DISTURBANCE_TYPE_1 + DISTANCE_TO_PERIMETER,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1.1e)

logistic.GLM1.1f <- glm(PLI.f ~ PROJ_HEIGHT_1_1 + DISTANCE_TO_PERIMETER,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1.1f)

logistic.GLM1.1g <- glm(PLI.f ~ years_since + PROJ_HEIGHT_1_1 + DISTANCE_TO_PERIMETER,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1.1g)

logistic.GLM1.1h <- glm(PLI.f ~ years_since + PROJ_HEIGHT_1_1 + DISTANCE_TO_PERIMETER,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(logistic.GLM1.1h)
```
