...
pairs(~ hot.dry.anomalies.MAT + hot.dry.anomalies.MWMT + hot.dry.anomalies.MAP + 
        ...
        hot.dry.anomalies.Tmax_sm + hot.dry.anomalies.PPT_sm + hot.dry.anomalies.MCMT +
        hot.dry.anomalies.CMI_sm,
...
zscores_regen$PLI.f <- as.factor(zscores_regen$PLI_count_bin)
zscores_regen$FDI.f <- as.factor(zscores_regen$FDI_count_bin)
```
# start modeling
...
climate.PLIa <- glm(PLI.f ~ hot.dry.anomalies.MAT,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIa)

climate.PLIb <- glm(PLI.f ~ hot.dry.anomalies.MCMT,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIb)

climate.PLIc <- glm(PLI.f ~ hot.dry.anomalies.MWMT,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIc)

climate.PLId <- glm(PLI.f ~ hot.dry.anomalies.MAP,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLId)

climate.PLIe <- glm(PLI.f ~ hot.dry.anomalies.PAS,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIe)

climate.PLIf <- glm(PLI.f ~ hot.dry.anomalies.AHM,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIf)

climate.PLIg <- glm(PLI.f ~ hot.dry.anomalies.SHM,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIg)

climate.PLIh <- glm(PLI.f ~ hot.dry.anomalies.Tmax_sm,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIh)

climate.PLIi <- glm(PLI.f ~ hot.dry.anomalies.PPT_sm,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIi)

climate.PLIj <- glm(PLI.f ~ hot.dry.anomalies.CMI_sm,
    family=binomial(link = "logit"), data=zscores_regen)
...
climate.PLIa <- glm(PLI.f ~ cool.wet.anomalies.MAT,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIa)

climate.PLIb <- glm(PLI.f ~ cool.wet.anomalies.MCMT,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIb)

climate.PLIc <- glm(PLI.f ~ cool.wet.anomalies.MWMT,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIc)

climate.PLId <- glm(PLI.f ~ cool.wet.anomalies.MAP,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLId)

climate.PLIe <- glm(PLI.f ~ cool.wet.anomalies.PAS,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIe)

climate.PLIf <- glm(PLI.f ~ cool.wet.anomalies.AHM,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIf)

climate.PLIg <- glm(PLI.f ~ cool.wet.anomalies.SHM,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIg)

climate.PLIh <- glm(PLI.f ~ cool.wet.anomalies.Tmax_sm,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIh)

climate.PLIi <- glm(PLI.f ~ cool.wet.anomalies.PPT_sm,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIi)

climate.PLIj <- glm(PLI.f ~ cool.wet.anomalies.CMI_sm,
    family=binomial(link = "logit"), data=zscores_regen)
summary(climate.PLIj)
