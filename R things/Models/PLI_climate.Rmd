...
climate.PLI.2b <- glm(PLI.f ~ years_since  + MWMT + NFFD,
                        family = binomial(link="logit"), data=climate)
summary(climate.PLI.2b)
lrtest(climate.PLI.2b, climate.PLI.2a)

climate.PLI.2c <- glm(PLI.f ~ years_since  +  NFFD,
                        family = binomial(link="logit"), data=climate)
summary(climate.PLI.2c)
lrtest(climate.PLI.2b, climate.PLI.2c)

climate.PLI.2d <- glm(PLI.f ~ years_since + NFFD + cool.wet.anomalies.MCMT ,
                        family = binomial(link="logit"), data=climate)
...
```
```{r}
climate.PLI.3 <- glm(PLI.f ~  NFFD,
                        family = binomial(link="logit"), data=climate)
summary(climate.PLI.3)

climate.PLI.3a <- glm(PLI.f ~ years_since  + NFFD,
                        family = binomial(link="logit"), data=climate)
summary(climate.PLI.3a)
```
