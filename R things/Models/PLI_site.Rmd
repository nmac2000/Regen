...
bin_dis_GIS1$BEC_Subzone <- factor(bin_dis_GIS1$BEC_Subzone,
                                   ...
                                   labels = c("IDFdk", "IDFxm", "SBPSdc", "SBPSmk", "SBPSxc"))
...
site.PLI.2d <- glm(PLI.f ~ years_since + BEC_Zone + PARENT_SOILS + Slope + I(Slope*sin(Aspect*(pi/180))) + I(Slope*cos(Aspect*(pi/180))) ,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2d)
...
site.PLI.2h <- glm(PLI.f ~ years_since + BEC_Zone + PARENT_SOILS  + Slope +Elevation,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2h)
...
site.PLI.2d <- glm(PLI.f ~ years_since + BEC_Subzone + PARENT_SOILS + Slope + I(Slope*sin(Aspect*(pi/180)) + I(Slope*cos(Aspect*(pi/180)))) ,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2d)
lrtest(site.PLI.2d, site.PLI.2c)
