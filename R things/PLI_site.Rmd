...
site.PLI.2d <- glm(PLI.f ~ years_since + BEC_Zone + PARENT_SOILS + Elevation,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2d)
lrtest(site.PLI.2d, site.PLI.2c)

site.PLI.2e <- glm(PLI.f ~ years_since + BEC_Zone + PARENT_SOILS + Slope,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2e)
lrtest(site.PLI.2e, site.PLI.2c)

site.PLI.2f <- glm(PLI.f ~ years_since + BEC_Zone + PARENT_SOILS + Slope + Aspect,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2f)
lrtest(site.PLI.2f, site.PLI.2e)

site.PLI.2g <- glm(PLI.f ~ years_since + BEC_Zone + PARENT_SOILS + Slope + Solar_Radiation,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2g)
lrtest(site.PLI.2g, site.PLI.2e)

site.PLI.2h <- glm(PLI.f ~ years_since + BEC_Zone + PARENT_SOILS  + Slope + TWI,
    family=binomial(link = "logit"), data=bin_dis_GIS1)
summary(site.PLI.2h)
