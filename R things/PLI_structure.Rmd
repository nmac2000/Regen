...
bin_dis_GIS1$BARC.y <- as.factor(bin_dis_GIS1$BARC.y)
...
```{r}
bin_dis_GIS1$linpred.GLM2a <- predict(structure.PLI.2e) # Estimated logit using the linear part
bin_dis_GIS1$yhat.GLM2a <- fitted(structure.PLI.2e) # Estimated probability using inverse logityhat values
bin_dis_GIS1$resid.GLM2a <- resid(structure.PLI.2e) # the deviances 
